...
public class TimeController {
    public static boolean addTime(AddTime addTimes) {
        ArrayList<AddTime> addTimeList = DBConnection.getInstance().getAddTime();
    ...
    public static boolean addTime2(AddTime addTimes2) {
        ArrayList<AddTime> addTimeList2 = DBConnection.getInstance().getAddTime2();
    ...
    public static boolean addTime3(AddTime addTimes3) {
        ArrayList<AddTime> addTimeList3 = DBConnection.getInstance().getAddTime3();
    ...
    public static boolean addTime4(AddTime addTimes4) {
        ArrayList<AddTime> addTimeList4 = DBConnection.getInstance().getAddTime4();
